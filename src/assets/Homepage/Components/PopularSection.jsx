...
import "../../Home/PopularSection.css";
// images for popular section

import HennaPaste from "../../Image/Henna.avif"; 
import FaceWash from "../../Image/orange.avif";
import NightGel from "../../Image/alone.avif";
import Shampoo from "../../Image/olive.avif";
import HairOil from "../../Image/Raw.avif"; 
import FaceCream from "../../Image/Summer.avif";
import BodyLotion from "../../Image/ubtan.avif";
import Sunscreen from "../../Image/website.avif";
...
const PopularSection = () => {
  ...
  return (
    <section className="popular-container">
      <h2 className="title">Popular & Trending</h2>
